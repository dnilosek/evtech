...
EVTech could always use more documentation, whether as part of the
official EVTech docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
3. The pull request should work for Python 3.5, 3.6, 3.7 and 3.8, and for PyPy. Check
   https://travis-ci.org/dnilosek/evtech/pull_requests
